  ...
  <div v-if="isMiniSidebar" data-testid="nc-workspace-menu" class="nc-workspace-menu nc-mini-sidebar-ws-item">
    <a href="https://github.com/nocodb/nocodb" target="_blank" rel="noopener noreferrer">
      <NcTooltip :disabled="!appInfo?.version || isEeUI" placement="right" hide-on-click>
        ...
        <GeneralWorkspaceIcon :workspace="{
          id: 'nc',
          meta: {},
        }" icon-bg-color="#F4F4F5" show-nocodb-icon class="flex-none border-1 border-nc-border-gray-medium"
          size="mini-sidebar" />
      </NcTooltip>
    </a>
  </div>
  <div v-else class="flex flex-row flex-grow pl-0.5 pr-1 py-0.5 rounded-md w-full"
    ...
    <div class="flex-grow min-w-20">
      <div data-testid="nc-workspace-menu"
        ...
        <a class="transition-all duration-200 transform w-24 min-w-10" href="https://github.com/nocodb/nocodb"
